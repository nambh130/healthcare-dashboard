...
const Calendar = () => {
  ...
  const clickupdateevent = () => {
    for (let i = 0; i < defaultEvents.length; i++) {
      if (defaultEvents[i].id === parseInt(calenderevent.id)) {
        defaultEvents[i].title = event_title;
      }
    }
    setiseditdelete(false);
  };
                  ...
                  <div className="col-auto text-end float-end ms-auto">
                    <Link to="/add-event">
                      ...
                      <div className="col-lg-2 col-sm-12">
                        <a href="#" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_event">
                          Create Event
                        </a>
                      </div>
                    </Link>
