...
import PaidInvoiceHeaderContent from "./PaidInvoiceHeaderContent";
...
const PaidInvoice = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => <div className="badge bg-success-light">{record.status1}</div>,
    },
    {
      title: "Action",
      dataIndex: "",
