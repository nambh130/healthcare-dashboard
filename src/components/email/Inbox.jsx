                  ...
                  <div className="chat-widgets">
                      ...
                      <div className="chat-users user-main">
                        ...
                        <div className="drop-item chat-menu user-dot-list">
                          ...
                          <div className="dropdown-menu" style={{}}>
                            ...
                            <Link className="dropdown-item" to="#">
                              <i className="feather-plus-circle me-2 text-success" /> Archive
                            </Link>
                            <Link className="dropdown-item" to="#">
                    ...
                    <div className="compose-mail">
                      <Link to="/compose-mail" className="btn btn-primary">
                        <img src={editicon2} className="me-2" alt="img" />
                        Compose Mail
                      </Link>
                    </div>
                    <div className="email-menu-blk">
                      <ul>
                        <li className="active">
                          <Link to="#">
                            <img src={inboxicon} className="me-2" alt="img" />
                            Inbox<span className="comman-flex">50</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={sendicon} className="me-2" alt="img" />
                            Sent <span className="comman-flex">120</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={drafticon} className="me-2" alt="img" />
                            Draft <span className="comman-flex">20</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={staricon} className="me-2" alt="img" />
                            Starred <span className="comman-flex">05</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={trashicon} className="me-2" alt="img" />
                    ...
                    <div className="label-blk comman-space-flex">
                      ...
                      <ul className="nav label-add-list">
                        ...
                        <li>
                          <Link to="#" data-bs-toggle="dropdown" aria-expanded="false" className="add-list-btn">
                            <i className="feather-more-vertical">
                              <FeatherIcon icon="more-vertical" />
                            </i>
                          </Link>
                    ...
                    <div className="email-menu-blk">
                      <ul>
                        <li>
                          <Link to="#">
                            <img src={tagicon01} className="me-2" alt="img" />
                            Work<span className="comman-flex">50</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={tagicon02} className="me-2" alt="img" />
                            Personal <span className="comman-flex">120</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={tagicon03} className="me-2" alt="img" />
                    ...
                    <div className="email-menu-blk">
                      <ul className="mb-0">
                        <li>
                          <Link to="#">
                            <img src={foldericon01} className="me-2" alt="img" />
                            Personal<span className="comman-flex">50</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={foldericon02} className="me-2" alt="img" />
                            Office <span className="comman-flex">120</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={foldericon03} className="me-2" alt="img" />
                            Bills <span className="comman-flex">20</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="#">
                            <img src={foldericon04} className="me-2" alt="img" />
                      ...
                      <tbody>
                        <tr className="unread clickable-row" data-to="/mail-view">
                          ...
                          <td className="name">
                            <div className="email-img-blk">
                              <div className="email-img">
                                <img src={profileavatar03} alt="img" />
                              </div>
                              <div className="send-user">
                                <h4>
                                  Bernardo James <span className="email-market">Marketting</span>
                                </h4>
                          ...
                          <td className="mail-date">
                            <img src={clipicons} className="me-2" alt="img" />
                            13:14
                          </td>
                        </tr>
                        <tr className="unread clickable-row" data-to="/mail-view">
                          ...
                          <td className="name">
                            <div className="email-img-blk">
                              <div className="email-img">
                                <img src={profileavatar04} alt="img" />
                              </div>
                              <div className="send-user">
                                <h4>
                                  Galaviz Lalema <span className="email-bills">Bills</span>
                                </h4>
                                <p>
                                  Fwd: quis nostrud exercitation ullamco laboris nisi ut aliquip voluptate velit esse
                                  cillum.
                                </p>
                              </div>
                            </div>
                        ...
                        <tr className="clickable-row" data-to="/mail-view">
                          ...
                          <td className="name">
                            <div className="email-img-blk">
                              <div className="email-img">
                                <img src={profileavatar05} alt="img" />
                              </div>
                              <div className="send-user">
                                <h4>
                                  Bernardo James <span className="email-work">Work</span>
                                </h4>
                        ...
                        <tr className="unread clickable-row" data-to="/mail-view">
                          ...
                          <td className="name">
                            <div className="email-img-blk">
                              <div className="email-img">
                                <img src={blogimg10} alt="img" />
                              </div>
                              <div className="send-user">
                                <h4>
                                  Bernardo James <span className="email-office">Office</span>
                                </h4>
                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa</p>
                              </div>
                            </div>
                        ...
                        <tr className="clickable-row" data-to="/mail-view">
                          ...
                          <td className="name">
                            <div className="email-img-blk">
                              <div className="email-img">
                                <img src={profileavatar07} alt="img" />
                              </div>
                              <div className="send-user">
                                <h4>
                                  Bernardo James <span className="email-market">Marketting</span>
