...
import { invoicereportdata } from "../../global-data/TableData";
...
const InvoiceReport = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => <div className="custom-badge status-green ">{record.Status}</div>,
    },
    {
      title: "",
      dataIndex: "FIELD8",
  ...
  return (
    <>
      <Header />
      <Sidebar id="menu-item12" id1="menu-items12" activeClassName="invoice-report" />
      <>
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                ...
                                <Link to="/add-expense" className="btn btn-primary doctor-refresh ms-2">
