...
import RadialBarChart from "../patient-dashboard/FullChart";
                            ...
                            <tbody>
                              <tr>
                                <td className="table-image appoint-doctor">
                                  <img width={28} height={28} className="rounded-circle" src={blogimg4} alt="" />
                              ...
                              <tr>
                                <td className="table-image appoint-doctor">
                                  <img width={28} height={28} className="rounded-circle" src={blogimg6} alt="" />
                              ...
                              <tr>
                                <td className="table-image appoint-doctor">
                                  <img width={28} height={28} className="rounded-circle" src={blogimg12} alt="" />
                                  <h2>Dr.Martin Doe</h2>
                                </td>
                                <td className="appoint-time text-center">
                                  <h6>Today 5:40 PM</h6>
                          ...
                          <div className="dolor-activity hide-activity">
                            <ul className="doctor-date-list mb-2">
                              ...
                              <li className=" dropdown ongoing-blk ">
                                <Link to="#" className="dropdown-toggle  active-doctor" data-bs-toggle="dropdown">
                                ...
                                <ul className="doctor-sub-list dropdown-menu">
                                  ...
                                  <li className="schedule-blk mb-0 pt-2 dropdown-item">
                                    ...
                                    <Link className="btn btn-primary appoint-start">Start Appointment</Link>
                                  </li>
                                </ul>
                              </li>
                            </ul>
