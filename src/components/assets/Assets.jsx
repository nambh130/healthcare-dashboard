                        ...
                        <div className="doctor-table-blk">
                          ...
                          <div className="doctor-search-blk">
                            ...
                            <div className="add-group">
                              <Link to="/add-asset" className="btn btn-primary add-pluss ms-2">
                        ...
                        <tr>
                          ...
                          <td className="profile-image">
                            <Link to="profile.html">
                              <img width={28} height={28} src={proavatar} className="rounded-circle m-r-5" alt="" />{" "}
                              Andrea Lalema
                            </Link>
                          </td>
