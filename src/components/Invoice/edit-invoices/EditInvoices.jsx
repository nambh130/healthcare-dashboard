...
import InvoicePreview from "../add-invoices/InvoicePreview";
import DeleteInvoices from "../add-invoices/DeleteInvoices";
import SaveInvoice from "../add-invoices/SaveInvoice";
import BankDetails from "../add-invoices/BankDetails";
...
const EditInvoices = () => {
  ...
  return (
    <>
      <Header />
      <Sidebar id="menu-item13" id1="menu-items13" activeClassName="edit-invoice" />
      <>
                            ...
                            <tbody>
                              <tr className="add-row">
                                ...
                                <td
                                  ...
                                  <Link to="#" className="add-btn me-2" onClick={addRow}>
                              ...
                              {rows.map((row) => (
                                <tr key={row.id}>
                                  ...
                                  <td className="add-remove text-end">
                                    ...
                                    <Link to="#" className="remove-btn" onClick={() => removeRow(row.id)}>
                                      <i className="fe fe-trash-2">
                                        <FeatherIcon icon="trash-2" />
                                      </i>
                                    </Link>
                        ...
                        <div className="col-lg-7 col-md-6">
                          <div className="invoice-fields">
                            ...
                            <div className="payment-details">
                              ...
                              <Link to="#" data-bs-toggle="modal" data-bs-target="#delete_bank_details">
                          ...
                          <div className="invoice-total-card">
                            ...
                            <div className="invoice-total-box">
                              <div className="invoice-total-inner">
                                    ...
                                    return (
                                      <div
                                        ...
                                        <div className="service-amount">
                                          <Link to="#" className="service-trash" onClick={removeInputFields}>
                                ...
                                <Link to="#" className="add-links-one" onClick={addInputField}>
                                ...
                                <div className="links-info-discount">
                                  <div className="links-cont-discount">
                                    {inputFieldsNew.map((data, index) => {
                                      return (
                                        <div
                                          className="links-count"
                                          key={index}
                                          onChange={(evnt) => handleChangesNew(index, evnt)}>
                                          <div className="service-amount">
                                            <Link to="#" className="service-trash" onClick={removeInputFieldsNew}>
                                              <i className="fe fe-minus-circle me-1">
                                                <FeatherIcon icon="minus-circle" className="invoice-minus" />
                                              </i>
                                              Offer New
                                    ...
                                    <Link to="#" className="add-links-one" onClick={addInputFieldNew}>
