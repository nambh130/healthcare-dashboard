...
const Invoice = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => (
                <>
                    {text === "Paid" && <span className="custom-badge status-green">{text}</span>}
                    {text === "Un paid" && <span className="custom-badge status-pink">{text}</span>}

                    {text === "patially paid" && <span className="custom-badge status-orange">{text}</span>}
    ...
    return (
        <>
            <Header />
            <Sidebar id="menu-item7" id1="menu-items7" activeClassName="invoice-list" />
            <>
                <div>
