...
import { employeedata } from "../../global-data/TableData";
...
const EmployeeSalary = () => {
  ...
  const columns = [
      ...
      render: (text, record) => (
        <div>
          <Dropdown onSelect={handleDropdownChange}>
            <div className="custom-badge status-purple">
              {record.Role}
    ...
    },
    {
      ...
      render: (text, record) => <div className="btn btn-sm btn-primary">{record.status}</div>,
    },
    {
      title: "",
      dataIndex: "FIELD8",
          ...
          <div className="text-end">
            <div className="dropdown dropdown-action">
              ...
              <div className="dropdown-menu dropdown-menu-end">
                <Link className="dropdown-item" to="/edit-salary">
  ...
  return (
    <>
      <Header />
      <Sidebar id="menu-item8" id1="menu-items8" activeClassName="employee-salary" />
      <>
                            ...
                            <div className="doctor-table-blk">
                              ...
                              <div className="doctor-search-blk">
                                ...
                                <div className="add-group">
                                  <Link to="/add-salary" className="btn btn-primary add-pluss ms-2">
