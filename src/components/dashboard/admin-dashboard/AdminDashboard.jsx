              ...
              <div className="col-12 col-md-12  col-xl-8">
                <div className="card">
                  <div className="card-header">
                    ...
                    <Link to="/appoinment-list" className="patient-views float-end">
                      Show all
                    </Link>
                  </div>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="table-image appoint-doctor">
                              <img width={28} height={28} className="rounded-circle" src={Avatar2} alt="#" />
                            ...
                            <td className="text-end">
                              <div className="dropdown dropdown-action">
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                  <Link className="dropdown-item" to="/appoinment-list">
                          ...
                          <tr>
                            ...
                            <td className="table-image appoint-doctor">
                              <img width={28} height={28} className="rounded-circle" src={Avatar3} alt="#" />
                          ...
                          <tr>
                            ...
                            <td>Bernardo </td>
                            <td className="table-image appoint-doctor">
                              <img width={28} height={28} className="rounded-circle" src={Avatar4} alt="#" />
                              <h2>Dr.Martin Doe</h2>
                            </td>
                            <td className="appoint-time">
                          ...
                          <tr>
                            ...
                            <td className="table-image appoint-doctor">
                              <img width={28} height={28} className="rounded-circle" src={Avatar5} alt="#" />
                          ...
                          <tr>
                            ...
                            <td>Cristina Groves</td>
                            <td className="table-image appoint-doctor">
                              <img width={28} height={28} className="rounded-circle" src={Avatar3} />
                              <h2>Dr.Angelica Ramos</h2>
                            </td>
                            <td className="appoint-time">
              ...
              <div className="col-12 col-xl-12">
                <div className="card">
                  <div className="card-header pb-0">
                    ...
                    <Link to="/edit-patients" className="float-end patient-views">
                      Show all
                    </Link>
                  </div>
