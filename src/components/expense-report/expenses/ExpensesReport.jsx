...
import { ExpenseReportData } from "../../global-data/TableData";
...
const ExpensesReport = () => {
  ...
  return (
    <>
      <Header />
      <Sidebar id="menu-item12" id1="menu-items12" activeClassName="expenses-report" />
      <>
                          ...
                          <div className="doctor-table-blk">
                            ...
                            <div className="doctor-search-blk">
                              ...
                              <div className="add-group">
                                ...
                                <Link to="to" className="btn btn-primary doctor-refresh ms-2">
