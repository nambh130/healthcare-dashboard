                    ...
                    <div className="card-body">
                      ...
                      <ul className="nav nav-tabs">
                        <li className="nav-item">
                          <Link className="nav-link active" to="#basictab1" data-bs-toggle="tab">
                            Home
                          </Link>
                        </li>
                        <li className="nav-item">
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <ul className="nav nav-tabs nav-justified">
                        <li className="nav-item">
                          <Link className="nav-link active" to="#basic-justified-tab1" data-bs-toggle="tab">
                            Home
                          </Link>
                        </li>
                        <li className="nav-item">
                          <Link className="nav-link" to="#basic-justified-tab2" data-bs-toggle="tab">
                            Profile
                          </Link>
                        </li>
                        <li className="nav-item dropdown">
                          ...
                          <div className="dropdown-menu dropdown-menu-right">
                            <Link className="dropdown-item" to="#basic-justified-tab3" data-bs-toggle="tab">
                              Dropdown 1
                            </Link>
                            <Link className="dropdown-item" to="#basic-justified-tab4" data-bs-toggle="tab">
                              Dropdown 2
                            </Link>
                          </div>
                        </li>
