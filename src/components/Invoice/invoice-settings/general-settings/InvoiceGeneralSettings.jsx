...
const InvoiceGeneralSettings = () => {
  ...
  return (
    <>
      <Header />
      <Sidebar id="menu-item13" id1="menu-items13" activeClassName="invoice-settings" />
      <>
                ...
                <div className="card invoices-settings-card">
                  ...
                  <div className="card-body">
                    ...
                    <form action="#" className="invoices-settings-form">
                      <div className="row align-items-center form-group">
                        ...
                        <div className="col-sm-9">
                          <label className="custom_check">
                            ...
                            <span className="checkmark" /> Change invoice status to paid after an order is complete
                          </label>
                        </div>
                      </div>
                      <div className="row align-items-center form-group">
                      ...
                      <div className="row align-items-center form-group">
                        <label htmlFor="phone" className="col-sm-3 col-form-label input-label">
                      ...
                      <div className="row align-items-center form-group">
                        <label htmlFor="addressline1" className="col-sm-3 col-form-label input-label">
                          Prefix
                        </label>
                        <div className="col-sm-9">
                          <input type="text" className="form-control" />
                      ...
                      <div className="row align-items-center form-group">
                        <label htmlFor="addressline2" className="col-sm-3 col-form-label input-label">
                          Number Reset
                        </label>
                        <div className="col-sm-9">
                          <input type="text" className="form-control" />
                      ...
                      <div className="row align-items-center form-group">
                        <label htmlFor="zipcode" className="col-sm-3 col-form-label input-label">
                          Default Due Time
                        </label>
                        <div className="col-sm-9">
                          <input type="text" className="form-control" />
...
export default InvoiceGeneralSettings;
