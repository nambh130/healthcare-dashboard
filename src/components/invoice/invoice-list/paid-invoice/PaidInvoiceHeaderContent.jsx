...
const PaidInvoiceHeaderContent = () => {
                ...
                <li>
                  <div className="multipleSelection">
                    <div className="selectBox" onClick={() => toggleSetShow(!show)}>
                      <p className="mb-0">
                        <i className="fas fa-user-plus me-1 select-icon"></i> Select User
                      </p>
                ...
                <li>
                  <div className="multipleSelection">
                    <div className="selectBox" onClick={() => toggleSetShowone(!show1)}>
                      <p className="mb-0">
                        <i className="fas fa-calendar me-1 select-icon"></i> Select Date
                      </p>
                      <span className="down-icon">
                        <i className="fas fa-chevron-down"></i>
                      </span>
                ...
                <li>
                  <div className="multipleSelection">
                    <div className="selectBox" onClick={() => toggleSetShowtwo(!show2)}>
                      <p className="mb-0">
                        <i className="fas fa-book-open me-1 select-icon"></i> Select Status
                      </p>
                      <span className="down-icon">
                        <i className="fas fa-chevron-down"></i>
                      </span>
                ...
                <li>
                  <div className="multipleSelection">
                    <div className="selectBox" onClick={() => toggleSetShowthree(!show3)}>
                      <p className="mb-0">
                        <i className="fas fa-bookmark me-1 select-icon"></i> By Category
                      </p>
                      <span className="down-icon">
                        <i className="fas fa-chevron-down"></i>
                      </span>
            ...
            <div className="row align-items-center">
              <div className="col-lg-8 col-md-8">
                <div className="invoices-tabs">
                  <ul>
                    <li>
                      <Link to="/invoice-list">All Invoice</Link>
                    </li>
                    <li>
                      <Link to="/paid-invoice" className="active">
                        Paid
                      </Link>
                    </li>
                    <li>
                      <Link to="/overdue-invoice">Overdue</Link>
                    </li>
                    <li>
                      <Link to="/draft-invoice">Draft</Link>
                    </li>
                    <li>
                      <Link to="/recurring-invoice">Recurring</Link>
                    </li>
                    <li>
                      <Link to="/cancelled-invoice">Cancelled</Link>
                    </li>
                  </ul>
                </div>
              </div>
...
export default PaidInvoiceHeaderContent;
