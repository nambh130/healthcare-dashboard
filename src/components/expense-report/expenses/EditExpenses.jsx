                    ...
                    <form>
                      <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Purchase From <span className="login-danger">*</span>
                            </label>
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms cal-icon">
                            <label>
                              Purchase Date <span className="login-danger">*</span>
                            </label>
                            <DatePicker
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Purchased by <span className="login-danger">*</span>
                            </label>
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Payment Status <span className="login-danger">*</span>
                            </label>
                            <select className="form-control select">
