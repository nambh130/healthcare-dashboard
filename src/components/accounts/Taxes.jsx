...
const Taxes = () => {
  ...
  const column = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <div>
          {text === "Active" && <span className="custom-badge status-green">{text}</span>}
          {text === "IN Active" && <span className="custom-badge status-pink">{text}</span>}
        </div>
      ),
    },
    {
                  ...
                  <div className="card card-table show-entire">
                    <div className="card-body">
                      ...
                      <div className="page-table-header mb-2">
                        <div className="row align-items-center">
                            ...
                            <div className="doctor-table-blk">
                              ...
                              <div className="doctor-search-blk">
                                ...
                                <div className="add-group">
                                  <Link to="/add-tax" className="btn btn-primary add-pluss ms-2">
                          ...
                          <div className="col-auto text-end float-end ms-auto download-grp">
                            ...
                            <Link to="#" className=" me-2">
                              <img src={pdficon2} aria-valuetext="#" />
                            </Link>
                            <Link to="#" className=" me-2">
                      ...
                      <div className="table-responsive">
                        <Table
                          className="table table-stripped table-hover datatable thead-light mb-0 "
                          pagination={{
