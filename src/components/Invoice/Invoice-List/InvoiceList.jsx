...
import { invoice_list_data } from "../../global-data/TableData";
...
const InvoiceList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => <div className="text-primary">{record.Amount}</div>,
    },
    {
      title: "Due data",
      dataIndex: "Due_data",
    ...
    },
    {
      ...
      render: (text, record) => (
        <div>
          {text === "Paid" && <span className="badge bg-success-light">{text}</span>}
          {text === "Overdue" && <span className="badge bg-danger-light">{text}</span>}
          {text === "Cancelled" && <span className="badge bg-primary-light">{text}</span>}
        </div>
      ),
    },
    {
  ...
  return (
    <>
      <Header />
      <Sidebar id="menu-item13" id1="menu-items13" activeClassName="invoice-list" />
      <>
