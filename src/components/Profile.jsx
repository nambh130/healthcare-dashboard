          ...
          <div className="content">
            <div className="row">
              ...
              <div className="col-sm-5 col-6 text-end m-b-30">
                <Link to="edit-profile.html" className="btn btn-primary btn-rounded">
                  ...
                  <div className="profile-view">
                    <div className="profile-img-wrap">
                      <div className="profile-img">
                        <Link to="#">
                          <img className="avatar" src={doctor3} alt />
                        </Link>
                      </div>
                    </div>
                        ...
                        <div className="col-md-7">
                          <ul className="personal-info">
                            <li>
                              ...
                              <span className="text">
                                <Link to>770-889-6484</Link>
                              </span>
                            </li>
                            <li>
                              <span className="title">Email:</span>
                              <span className="text">
                                <Link to>cristinagroves@example.com</Link>
                              </span>
                            </li>
                            <li>
            ...
            <div className="profile-tabs">
              <ul className="nav nav-tabs nav-tabs-bottom">
                <li className="nav-item">
                  <Link className="nav-link active" to="#about-cont" data-bs-toggle="tab">
                    About
                  </Link>
                </li>
                <li className="nav-item">
