                ...
                <div className="col-sm-12">
                  <ul className="breadcrumb">
                    <li className="breadcrumb-item">
                      <Link to="/provident-fund">Accounts </Link>
                    </li>
                    <li className="breadcrumb-item">
                      <i className="fa fa-angle-right" />
                    </li>
                    <li className="breadcrumb-item active">Add Provident Fund</li>
                  </ul>
                </div>
              </div>
            </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Employee Name <span className="login-danger">*</span>
                            </label>
                            <Select
                              ...
                              styles={{
                                ...
                                control: (baseStyles, state) => ({
                                  ...baseStyles,
                                  borderColor: state.isFocused ? "none" : "2px solid rgba(46, 55, 164, 0.1)", // removed trailing semicolon
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Provident Fund Type <span className="login-danger">*</span>
                            </label>
                            <Select
                              defaultValue={selectedOption}
                              onChange={setSelectedOption}
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Employee Share ($) <span className="login-danger">*</span>
                            </label>
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Organization Share ($) <span className="login-danger">*</span>
                            </label>
                            <input className="form-control" type="text" />
                          </div>
                        </div>
...
export default AddProviderFund;
