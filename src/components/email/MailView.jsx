                  ...
                  <div className="chat-widgets">
                    ...
                    <div className="email-menu-blk">
                      <ul>
                        ...
                        <li>
                          <Link to="#">
                            <img src={tagicon04} className="me-2" alt="img" />
                  ...
                  <div className="mailview-content view-content-bottom">
                    ...
                    <div className="mailview-header comman-space-flex">
                      <div className="sender-info comman-flex">
                        <div className="sender-img">
                          <img alt="#" src={blogimg2} className="rounded-circle me-2" />
                        </div>
                      ...
                      <div className="mail-reports">
                        <ul className="nav">
                          ...
                          <li>
                            <Link to="#" className="ford-angle" data-bs-toggle="dropdown" aria-expanded="false">
                              <i className="feather-more-vertical">
                                <FeatherIcon icon="more-vertical" />
                              </i>
                            </Link>
                    ...
                    <div className="mail-attach">
                      ...
                      <ul className="msg-sub-list nav">
                        <li>
                          <img src={documenticon} alt="#" className="me-1" />
                          Expense.txt <span className="ms-1">30.0 MB</span>
                          <img src={chaticon07} alt="#" className="ms-2 " />
                          <i className="feather-x ms-2">
                            <FeatherIcon icon="x" />
                          </i>
                        </li>
                        <li>
                          <img src={galleryicon} alt="#" className="me-1" />
                    ...
                    <div className="forward-send">
                      <Link to="#" className="btn btn-primary replay-btn me-2">
                        <img src={replayicon} className="me-2" alt="img" />
                        Reply
                      </Link>
                      <Link to="#" className="btn btn-primary forwrd-btn">
                        <img src={replayicon01} className="me-2" alt="img" />
                        Forward
                      </Link>
                      <Link to="#">
                        <img src={printericon} className="ms-2 me-2" alt="img" />
                      </Link>
                      <Link to="#">
                        <img src={trashicon} className="me-2" alt="img" />
                      </Link>
