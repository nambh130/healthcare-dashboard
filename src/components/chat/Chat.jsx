                            ...
                            <div className="msg-box">
                              <div className="message-sub-box">
                                ...
                                <ul className="msg-sub-list">
                                  <li>
                                    <img src={chaticon4} alt="#" className="me-1" />
                                    Explainer Video.avi<span className="ms-1">30.0 MB</span>
                                    <img src={chaticon07} alt="#" className="ms-1 ms-auto" />
                                  </li>
                                  <li>
                                    <img src={chaticon5} alt="#" className="me-1" />
                                    Ayush Therapy.mp3<span className="ms-1">4.0 MB</span>
                                    <img src={chaticon8} alt="#" className="ms-1 ms-auto" />
                                  </li>
                                  <li>
                                    <img src={chaticon6} alt="#" className="me-1" />
                              ...
                              <div className="inputgroups">
                                ...
                                <div className="symple-text position-icon">
                                  <ul>
                                    <li>
                                      <Link to="#">
                                        <img src={chatfooter1} className="me-2" alt="#" />
                                      </Link>
                                    </li>
                                    <li>
                                      <Link to="#">
                                        <img src={chatfooter2} alt="#" />
                                      </Link>
                                    </li>
                                  </ul>
                                </div>
