...
import RecurringHeaderContent from "./RecurringHeaderContent";
...
const RecurringInvoice = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <div>
          {text === "Active" && <span className="badge bg-success dark">{text}</span>}
          {text === "Expired" && <span className="badge bg-danger dark">{text}</span>}
        </div>
      ),
    },
    {
