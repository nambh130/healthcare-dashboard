                    ...
                    <div className="chat-user-group video-call-blk d-flex align-items-center">
                      ...
                      <div className="chat-users chat-user-blk">
                        ...
                        <div className="chat-user-icon">
                          <Link to="#">
                            <img src={videoicon1} className="me-2" alt="img" />
                          </Link>
                          <Link to="#">
                            <img src={videoicon2} alt="img" />
                          </Link>
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="media-body flex-grow-1">
                            <div className="msg-box">
                              <div className="message-sub-box">
                                <h5>Smith Bruklin</h5>
                                <p>
                                  Vivamus sed dictum dictum ligula, cursus blandit risus Lorem ipsum dolor sit amet
                                  aliquam ut a ex aliquam ut a ex
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="join-contents horizontal-view fade-whiteboard">
                            <div className="join-video user-active">
                              ...
                              <div className="part-name">
                                <h4>
                                  <img src={videoicon3} className="me-2" alt="img" />
                                  Laura Strattenberg
                                </h4>
                              </div>
