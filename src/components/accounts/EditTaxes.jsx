                      ...
                      <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Tax Name <span className="login-danger">*</span>
                            </label>
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Tax Percentage <span className="login-danger">*</span>
                            </label>
                        ...
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="form-group local-forms">
                            <label>
                              Tax Method <span className="login-danger">*</span>
                            </label>
